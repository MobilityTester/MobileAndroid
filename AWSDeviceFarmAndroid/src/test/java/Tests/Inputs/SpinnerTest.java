...
public class SpinnerTest extends InputTests {
    ...
    public void checkIndex() {
        spinnerPage.selectSpinnerAtIndex(5);
        System.out.println("ExectedText:"+ spinnerPage.getDisplayText());
        System.out.println("ActualText:"+ String.format(SPINNER_BASE_STRING, spinnerPage.getSelectedEntry()));
