...
public class NavigationPage extends BasePage{
    ...
    public void gotoCategory(String categoryName) {
        ...
        System.out.println("Click element from Category Menu !");
        while (categoryElement == null) {
            try {
                ...
                String xpath_Categoryname = "//android.widget.TextView[@text='"+categoryName+"']";
                System.out.println(xpath_Categoryname);
                categoryElement = driver.findElement(By.xpath(xpath_Categoryname));
